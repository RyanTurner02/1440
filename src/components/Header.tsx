  ...
  return (
    <div className={`header header-${theme}`}>
      ...
      {hasDarkMode ?
        ...
        :
        <svg className="w-8 hover:cursor-pointer" onClick={() => { setHasDarkMode(true); toggleTheme() }} fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
